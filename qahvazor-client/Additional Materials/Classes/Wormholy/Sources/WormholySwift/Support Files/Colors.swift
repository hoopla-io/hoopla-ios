...
internal struct Colors {
    ...
    internal struct HTTPCode {
        static let Success = Color("#297E4C") //2xx
        static let Redirect = Color("#3D4140") //3xx
        static let ClientError = Color("#D97853") //4xx
        static let ServerError = Color("#D32C58") //5xx
        static let Generic = Color("#999999") //Others
